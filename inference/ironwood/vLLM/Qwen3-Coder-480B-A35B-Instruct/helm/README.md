...
**Important**: You must provide your own Google Cloud Service Account and Model Path in `values.yaml` by replacing the `YOUR_SERVICE_ACCOUNT` and `YOUR_MODEL_PATH` placeholders.
