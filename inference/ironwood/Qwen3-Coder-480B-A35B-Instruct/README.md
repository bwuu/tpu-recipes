...
prompts, etc, you can modify the settings in values.yaml. Note that you must replace `<YOUR_GCP_SERVICE_ACCOUNT>` with your actual GCP service account and `<HF_MODEL_ID>` with your model ID in `values.yaml` before running.
