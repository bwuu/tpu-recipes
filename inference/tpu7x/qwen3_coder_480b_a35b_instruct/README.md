...
You will also need to update the placeholders in `values.yaml` before running:
- Replace `test@developer.gserviceaccount.com` with your GCP service account.
- Replace `gs://YOUR_BUCKET/Qwen3-Coder-480B-A35B-Instruct` with the GCS path to your model weights.
