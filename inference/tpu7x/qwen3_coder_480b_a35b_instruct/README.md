...
### Set Placeholders in `values.yaml`

Before running the benchmark, you need to set some placeholders in the `values.yaml` file:
- Replace `YOUR_SERVICE_ACCOUNT` with your GCP service account email.
- Replace `YOUR_GCS_BUCKET` with the GCS bucket path where your model is located.
